...
export default function Home() {
    ...
    <div className="content">
      ...
      <div className="socials">
        <ul className="social-icons">
          ...
          {/* <li><a className="telegram" aria-label="Telegram" href="https://t.me/lifecode5" target="_blank"><i className="fab fa-telegram-plane" /></a></li> */}
          ...
          {/* <li><a className="dev" aria-label="Dev" href="https://dev.to/jigarsable" target="_blank"><i className="fab fa-dev" /></a></li> */}
        </ul>
      </div>
    </div>
    <div className="image">
  ...
  <section className="work" id="work">
    ...
    <div className="box-container">
      {/* <div class="box tilt">
<img draggable="false" src="./images/projects/portfolio1.PNG" alt="" />
<div class="content">
  <div class="tag">
